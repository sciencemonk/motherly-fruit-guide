      ...
      <div className="relative w-full max-w-3xl pl-8 md:pl-16 lg:pl-24 pr-4">
        <div className="max-w-2xl">
          <div className="flex mb-6">
            <div className="inline-flex items-center px-4 py-2 rounded-full bg-white text-black text-sm font-medium">
          ...
          <Dialog>
            <DialogTrigger asChild>
              <Button 
                className="bg-white hover:bg-gray-50 text-black font-semibold text-lg px-8 py-6 rounded-full shadow-lg transition-all duration-200 hover:scale-105"
              >
