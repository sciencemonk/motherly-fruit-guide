  ...
  const features = [
    {
      ...
      description: "Record your dreams instantly via text message. No apps to open, no typing on your phone's keyboard - just send a quick text right after you wake up."
    },
    {
  ...
  return (
    <section id="features" className="py-24 bg-white">
      <div className="container px-4 md:px-6">
        ...
        <div className="bg-sage-50 rounded-2xl p-8 md:p-12 max-w-4xl mx-auto">
